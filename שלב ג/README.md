...
## 4. אלגוריתם הינדוס לאחור (Reverse Engineering)

הינדוס לאחור הוא התהליך שבו, **מתוך הטבלאות (הסכמה הרלציונית) בלבד**, משחזרים את תרשים ה-ERD המושגי. האלגוריתם שבו השתמשנו:
